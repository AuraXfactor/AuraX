...
export default function ToolkitPage() {
  ...
  const cards = [
    { href: '/assessment', title: 'Self Assessment', desc: 'Anxiety, depression & personality screening', emoji: '📊', colors: 'from-blue-500 to-indigo-500' },
    ...
    { href: '/toolkit/grounding', title: 'Grounding Techniques', desc: 'Multiple grounding methods for anxiety', emoji: '🪨', colors: 'from-amber-400 to-orange-500' },
